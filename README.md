...
- [Online Commerce Cohort Analysis](https://public.tableau.com/views/Cohort-Retention-Dashboard/Dashboard1?:language=en-GB&publish=yes&:sid=&:display_count=n&:origin=viz_share_link) Loaded data from Azure Data Studio to build dashboard that visualizes the time-series retention rates of customer cohorts over time and dynamic percentage breakdowns of cohort behavior, enabling stakeholders to identify trends and patterns in customer retention and churn. 
