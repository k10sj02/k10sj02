...
- [Global Covid Tracking Project](https://github.com/k10sj02/covid-tracking-project-sql) Utilized MySQL and MySQL Workbench to execute a comprehensive project. Leveraged SQLAlchemy in Python to transform, clean, and upload data. Conducted exploratory data analytics to reveal global COVID-19 trends. Demonstrated SQL techniques such as Joins, Temp Tables, Aggregate Functions, Creating Views, and Data Type Conversion. Created dashboard in [Tableau](https://public.tableau.com/app/profile/stann6239/viz/covid-tracking-global/COVID-Dashboard)
