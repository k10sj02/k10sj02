...
- **SQL** (PostgreSQL - Docker & pgAdmin4, TSQL - Microsoft SQL Server, SQL Server Management Studio (SSMS) & Azure Data Studio, MySQL, Google BigQuery, Redash, SQLite)
